...
//Ajax call to updatepassword.php
 $("#updatepasswordform").submit(function(event){
    ...
    var datatopost = $(this).serializeArray();
     ...
     $("#updatepasswordmessage").html("<div class ='alert alert-danger'>There was an error with thte Ajax call. Please try again later.</div>"); 
...
//Ajax call to updateemail.php
 ...
 $("#updateemailform").submit(function(event){
    ...
    var datatopost = $(this).serializeArray();
     ...
     $("#updateemailmessage").html("<div class ='alert alert-danger'>There was an error with thte Ajax call. Please try again later.</div>"); 
